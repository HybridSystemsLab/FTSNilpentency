...
for i = 1:J+1,
   ...
   if (i>=2) & (i<=J+1)
       ...
       pPost = [xprev1, xpost1];
       plot(pPrev,pPost,'r--');
%        plot([xprev xprev1],[xpost xpost1],'r--');
       xprev = xith(length(xith));
       xprev1 = xith1(length(xith1));
       tprev = tith(length(tith));
   end
